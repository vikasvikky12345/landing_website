        ...
        {[...new Array(2)].map((_, outerIndex) => (
          <React.Fragment key={outerIndex}>
            {testimonials.map(({ text, imageSrc, name, username }, index) => (
              <div key={`${outerIndex}-${index}`} className="card">
  ...
  return (
    <section className="bg-white">
      <div className="container">
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-10 [mask-image:linear-gradient(to_bottom,transparent,black_25%,black_75%,transparent)]">
